            ...
            <div className="row">
              <div className="col-xs-12 col-sm-6 col-md-3">
                <div className="widget subscribe no-box">
                  <img
                    src="img/1272b85e76eebe70d35436eeb8970c46.png"
                    alt=""
                  ></img>
                </div>
              </div>
              ...
              <div className="col-xs-12 col-sm-6 col-md-3">
                <div className="widget no-box">
                  ...
                  <p>
                    <a
                      href="mailto:pitonmarquise@gmail.com"
                      title="glorythemes"
                    >
                      pitonmarquise@gmail.com
                    </a>
                  </p>
                  <ul className="social-footer2">
                    ...
                    <li className="">
                      <a
                        href="https://www.facebook.com/marquise.piton/"
                        target="_blank"
                        title="Facebook"
                      >
                        <img
                    ...
                    <li className="">
                      <a
                        title="instagram"
                        target="_blank"
                        href="https://www.instagram.com/sirquisepiton/"
                      >
                        <img
                          alt="instagram"
                          width="30"
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-12 text-center">
                <p>
                  I would like to thank my instructors and classmates at Awesome
                  Inc. for inspiring me to make this blog.
                </p>
              </div>
            </div>
          </div>
